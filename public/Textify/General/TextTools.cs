...
namespace Textify.General
{
    ...
    public static class TextTools
    {
        ...
        /// <summary>
        /// Trims the new lines from the top and the bottom of the string
        /// </summary>
        /// <param name="text">Text to process</param>
        /// <returns>A modified string with trimmed new lines from the top and the bottom</returns>
        public static string TrimNewLines(this string text) =>
            string.Join("\n", TrimNewLines(text.SplitNewLines()));
        ...
        public static string[] Paragraphize(this string text, bool wrapLines = true, int wrapWidth = 75)
        {
            ...
            paragraphized = TrimNewLines(paragraphized);
